...
const faqData: FaqItem[] = [
  {
    ...
    description:
      "Your first session is a gentle, getting-to-know-you conversation. Dr. Hayward will ask about your background, what brought you in, and what you'd like to achieve. There's no pressure to share more than you are comfortable with. Together you will outline a personalized treatment plan and next steps.",
  },
  {
    id: 2,
    ...
    image: faqInsurance,
    description:
      "Dr. Hayward does not accept insurance directly. She provides out-of-network documentation (superbills) that you may submit to your insurance for reimbursement. Many PPO plans cover out-of-network therapy, and Dr. Hayward can help you understand the paperwork.",
  },
  {
    id: 3,
